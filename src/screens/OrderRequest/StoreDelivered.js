...
const StoreDelivered = () => {
    ...
    const renderDeliveredorderRequest = () => {
        if (orderRequest) {
                        ...
                        <Card >
                            ...
                            <>
                                <View style={styles.cardRender} key={key}>
                                    ...
                                    <Text style={{textAlign : 'center'}}>STATUS : <Text style={{color : 'green'}}>{orderRequest[val].status}</Text></Text>
    ...
    return (
        <ScrollView>
            ...
            {renderDeliveredorderRequest()}
        </ScrollView>
    )
}

export default StoreDelivered;
